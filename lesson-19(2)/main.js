...
// 데이터베이스 연결 설정
mongoose.connect(
    "mongodb+srv://ut-node:pwPbabbazLda6ueg@ut-node.shy2gcv.mongodb.net/?retryWrites=true&w=majority&appName=UT-node", // 데이터베이스 연결 설정 atlas 경로
);
...
router.post(
  ...
  usersController.redirectView // 생성 ��으로부터의 데이터 제출과 뷰 출력을 위한 요청 처리
);
